    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#7a58a6">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF;font-size:40px;"> Online Feedback System</a>
...
You can perform all admin actions such as login to the account and check result , Update the details  , Add Faculty ...
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding-bottom:15px;height:40px; background:#66CCFF">
		<span style="color:#09334E;font-family:roboto;font-size:20px;">Developed By @Jagadeesh H</span>
	</div>
    <!-- jQuery -->
