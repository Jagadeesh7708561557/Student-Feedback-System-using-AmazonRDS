...
<td>
 <input type="radio" name="quest11" value="5" required>&nbsp5&nbsp
  <input type="radio" name="quest11" value="4">&nbsp4&nbsp
  <input type="radio" name="quest11" value="3">&nbsp3&nbsp
<input type="radio" name="quest11" value="2">&nbsp2&nbsp
<input type="radio" name="quest11" value="1">&nbsp1&nbsp</td>
</tr>
<tr>
<td><b>12:</b>Assessments conducted are clearly connected to maximize learining objectives:</td>
<Td>
 <input type="radio" name="quest12" value="5" required>&nbsp5&nbsp
  <input type="radio" name="quest12" value="4">&nbsp4&nbsp
  <input type="radio" name="quest12" value="3">&nbsp3&nbsp
<input type="radio" name="quest12" value="2">&nbsp2&nbsp
<input type="radio" name="quest12" value="1">&nbsp1&nbsp</td>
</tr>
</table>
