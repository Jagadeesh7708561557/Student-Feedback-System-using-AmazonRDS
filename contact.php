...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font class="text-info">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                   A-T Post<br>Prayag Chikhali, Tal Karveer Dist Kolhapur<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>:9552154924</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="pathanasazad12@gmail.com">pathanasazad12@gmail.com</a>
                </p>
